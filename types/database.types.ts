    ...
    Tables: {
      ...
      notification_configuration: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "notification_configuration_organization_user_id_fkey";
      ...
      offering_smart_contract_set: {
        Row: {
          ...
          offering_id: number;
          share_contract_address: string | null;
        ...
        Relationships: [
          {
            foreignKeyName:
              "offering_smart_contract_set_distribution_contract_address_fkey";
            columns: ["distribution_contract_address"];
            isOneToOne: false;
            referencedRelation: "smart_contract";
            referencedColumns: ["crypto_address_id"];
          },
          {
          ...
          {
            foreignKeyName:
              "offering_smart_contract_set_share_contract_address_fkey";
            columns: ["share_contract_address"];
            isOneToOne: false;
            referencedRelation: "smart_contract";
            referencedColumns: ["crypto_address_id"];
          },
          {
            foreignKeyName:
              "offering_smart_contract_set_swap_contract_address_fkey";
            columns: ["swap_contract_address"];
            isOneToOne: false;
            referencedRelation: "smart_contract";
            referencedColumns: ["crypto_address_id"];
          },
      ...
      whitelist_transaction: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "whitelist_transaction_offering_participant_id_fkey";
            columns: ["offering_participant_id"];
            isOneToOne: false;
            referencedRelation: "offering_participant";
            referencedColumns: ["id"];
