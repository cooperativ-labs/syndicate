...
- **“{{ bacName }}”** means the ERC20 Token with the identifier {{ bacAddress }} on the {{ chainName }} Blockchain, and which governs the transfer and chain of custody of the Shares herein;
- **“{{ spvEntityName }}”** is the legal entity whose shares are digitized through the Share Token Contract;
...
- **“Private Placement Memorandum”** A document describing the {{ spvEntityName }} selling the securities, the terms of the offering, and the risks of investing in the private offering, among other things, and which is distributed on request by {{ gpEntityName }} and available here: [{{ offeringPageUrl }}]({{ offeringPageUrl }});
- **“Operating Agreement” or “Limited Partnership Agreement”** A document describing how {{ spvEntityName }} is managed, who has ownership, and how decisions are made with regards to the real estate property in question, and which is distributed on request by {{ gpEntityName }} and available here: [{{ offeringPageUrl }}]({{ offeringPageUrl }}).

## **Terms:**

All share transfers, sales, dividends and subsequent transactions are governed by reference to the above-defined agreements as provided by {{ gpEntityName }} and located at [{{ offeringPageUrl }}]({{ offeringPageUrl }}). Where the terms enumerated herein remain silent or conflict with those aforementioned agreements, those terms are severable to the extent that they conflict with those agreements, without prejudicing the applicability of the remainder of the terms, which shall remain in force.
...
- Shareholders or Transferees of Shares distributed or transferred via the Share Token Contract are deemed to acknowledge and understand that in order to receive dividend distributions of {{ spvEntityName }}, they must accept the distribution requests sent to them by {{ gpEntityName }} at [{{ offeringPageUrl }}]({{ offeringPageUrl }}).
...
- Receipt of the Shares through the Share Token Contract shall also constitute acknowledgement and acceptance of the [Terms of Service ({{ termsOfServiceUrl }})]({{ termsOfServiceUrl }}) and moreover shall constitute acceptance of the Disclaimers of Liability prominently displayed at the {{ platformName }} website, and within the Terms of Service thereof.
