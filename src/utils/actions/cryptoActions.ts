...
export async function createSmartContract({
  ...
  ownerId,
  type
}: CreateSmartContractParams): Promise<CreateSmartContractResult> {
  const supabase = createClient();
...
export async function createSwapContract({
  ...
  chainId,
  revalidationPath
}: CreateSwapContractParams): Promise<CreateSwapContractResult> {
  const supabase = createClient();
...
export async function createDistributionContract({
  ...
  chainId,
  revalidationPath
}: CreateDistributionContractParams): Promise<CreateDistributionContractResult> {
  const supabase = createClient();
