...
export const getTabSectionOption = (
  ...
  return tabSectionOptions.find((
    option,
  ) => (option.value === desiredSectionValue ? option : null));
};
...
export const getPropertyTypeOption = (inputValue: RealEstatePropertyType) => {
  return propertyTypeOptions.find((
    option,
  ) => (option.value === inputValue ? option : null));
};
...
export const getTransferEventOption = (tradeType: ShareTransferEventType) => {
  return TransferEventOptions.find((
    option,
  ) => (option.value === tradeType ? option : null));
};
...
export const getCurrencyOption = (currency: Maybe<Currency> | undefined) => {
  return currencyOptions.find((
    cur,
  ) => (cur.value === currency?.code ? cur : null));
};
export const getCurrencyByCode = (
  ...
  return currencyOptions.find((
    cur,
  ) => (cur.value === currencyCode ? cur : null));
};
