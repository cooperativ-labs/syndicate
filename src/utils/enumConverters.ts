...
export const getDocFormatOption = (type: keyof typeof DocumentFormat | undefined) => {
...
export const getAssetStatusOption = (inputValue: OfferingStage | AssetStatus | undefined) => {
