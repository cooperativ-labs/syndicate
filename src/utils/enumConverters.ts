...
export const getTabSectionOption = (desiredSectionValue: keyof typeof OfferingTabSection) => {
...
export const getSocialAccountOption = (
  ...
  return socialAccountOptions.find(option => (option.value === type ? option : null));
};
...
): { value: OrganizationUserPermissionTypes; name: string; color: string } => {
  const defaultOption = {
...
export const getDocFormatOption = (type: keyof typeof DocumentFormat | undefined | null) => {
...
export const getDistributionPeriod = (period: keyof typeof DistributionPeriodType) => {
...
export const getPropertyTypeOption = (inputValue: keyof typeof RealEstatePropertyType) => {
...
export const getTransferEventOption = (tradeType: ShareTransferEventTypes | undefined) => {
...
export const currencyOptions = [
  ...
  },
  {
    ...
    symbol: 'USDC',
    address: '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48' as String0x,
  ...
  },
  {
    ...
    symbol: 'DAI',
    address: '0x6b175474e89094c44da98b954eedeac495271d0f' as String0x,
  ...
  },
  {
    ...
    symbol: 'Matic USDC',
    address: '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174' as String0x,
    website: 'https://www.centre.io/',
    protocol: CryptoAddressProtocol.Eth,
    chainId: 137,
    decimals: 18,
  ...
  },
  {
    ...
    symbol: 'Matic DAI',
    address: '0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063' as String0x,
    website: 'https://makerdao.com/',
    protocol: CryptoAddressProtocol.Eth,
    chainId: 137,
    decimals: 18
  },
  {
    ...
    symbol: 'USDC*',
    address: '0x66458Bb9BF8e09eA40cf916BCb370727455F6040' as String0x,
    website: 'https://www.centre.io/',
    protocol: CryptoAddressProtocol.Eth,
    decimals: 6,
    chainId: 11155111,
  ...
  },
  {
    ...
    symbol: 'DAI*',
    address: '0x3aa3DAd8008288CB5F9dc2F6e1e6213035ddBE88' as String0x,
    website: 'https://makerdao.com/',
    protocol: CryptoAddressProtocol.Eth,
    chainId: 11155111,
    decimals: 18,
  ...
  },
  {
    ...
    symbol: 'Matic USDC*',
    address: 'NEED ADDRESS' as String0x,
    website: 'https://www.centre.io/',
    protocol: CryptoAddressProtocol.Eth,
    chainId: 80001,
    decimals: 18,
...
export const cryptoOptions = currencyOptions.filter(option => option.type === CurrencyType.CRYP);
...
export const liveCurrencyOptions = cryptoOptions.filter(
  option => !testChainIds.includes(option.chainId as number)
);
...
export const getCurrencyOption = (currency: keyof typeof CurrencyCode | undefined | null) => {
  return currencyOptions.find(cur => (cur.value === currency ? cur : null));
};
export const getCurrencyByCode = (currencyCode: keyof typeof CurrencyCode | undefined) => {
